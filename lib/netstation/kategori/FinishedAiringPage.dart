...
class FinishedAiringPage extends StatefulWidget {
  final List<dynamic> filmDataNew;

  FinishedAiringPage({Key? key, required this.filmDataNew}) : super(key: key);

  @override
  State<FinishedAiringPage> createState() => _FinishedAiringPageState();
}

class _FinishedAiringPageState extends State<FinishedAiringPage> {
  @override
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> finishedAiringFilms =
        (widget.filmDataNew.cast<Map<String, dynamic>>()).where((filmData) =>
            filmData["status"] == "Finished Airing").toList();

    return Scaffold(
      appBar: AppBar(
        title: Text('Finished Airing'),
      ),
